...
public class SortCounttester {
	...
	public static void main(String args[]) {
		System.out.println("How many items in the array? 1000");
		System.out.println("Random (r), almost sorted (a), or fully sorted (f)? r");


		for(int i=0; i<10; i++)
		{
			int[] a; //={42229, 29279, 57912, 10853, 27643, 52513, 63058, 56818, 55344, 36109};       // the array
